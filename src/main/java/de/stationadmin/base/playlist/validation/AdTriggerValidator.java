  ...
  public boolean validate(Playlist playlist, List<Entry> violations) {
    ...
    if (!playlist.isShuffle()) {
      ...
      if (adTriggers != null) {
        ...
        // This approach accepts a missing ad trigger in the last semi hour if that is not completely filled
        ...
        /*
        // This approach would not accept a missing trigger in the last semi hour
