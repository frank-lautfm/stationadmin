...
/**
 * {@link TrackMetaDataReader} implementation for AAC audio files
 * (.aac, .m4a). Uses the JAudiotagger library to read iTunes MP4 atoms.
 *
 * @author Frank Korf
 */
public class AACMetaDataReader implements TrackMetaDataReader {
  ...
  public boolean supports(File file) {
    ...
    return name.endsWith(".aac") || name.endsWith(".m4a");
  }
