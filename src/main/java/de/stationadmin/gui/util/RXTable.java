 ...
 * 
 * @author based on http://tips4java.wordpress.com/2008/10/20/table-select-all-editor/
 */
public class RXTable extends JXTable {
  private static final long serialVersionUID = 3677051220005689188L;
